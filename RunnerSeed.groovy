if (RUNNER_JOB_NAME.contains('/')) {
    String parentDirectory = RUNNER_JOB_NAME.substring(0,RUNNER_JOB_NAME.lastIndexOf('/'))
    folder(parentDirectory) {
    }
}


pipelineJob("${RUNNER_JOB_NAME}") {
    parameters {
        ...
        cpsScm {
             scm {
                git {
                 ...
                 scriptPath('pipelines/Runner_Template.groovy')
              }
        }
